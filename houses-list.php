...
<html lang="nl">
   ...
   <body>
      ...
      <main class="properties-list">
         <section class="banner banner__inner" style="background-image: url(./media/images/header-properties.jpg);"> 
            <div class="container text-center">
               <div class="title text-center">
                  <h1 class="headline">Woningaanbod</h1>
               </div>
            </div>
         </section>
            ...
            <div class="container">
               ...
               <div class="row view-more">
                  <div class="col-12 text-center">
                     <a href="/houses-list.php" class="btn btn-lg btn-primary">View More</a>
                  </div>
               </div>
            </div>
         </section>
