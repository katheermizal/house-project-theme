...
(function ($) {
    $(document).ready(function () {
         ...
         $('#slick-nav').slick({
            slidesToShow: 8, 
            slidesToScroll: 1,
            asNavFor: '#slick-frame',
            dots: false,
            focusOnSelect: true  
         });

         $('#slick-frame').slickLightbox({ 
            src: 'src',
       ...
       contentLoadmore()
		...
		function contentLoadmore(){
			$('.load-more p').on('click', function () {
                $('.product-description .long-content').slideDown('slow')
                $(this).hide()
			})
        }

        /*** Call 360 view ***/
          $('.three-sixty-box').each(function(index) {
            $(this).addClass('three-sixty-box-'+index);
            $('.three-sixty-box-'+index).cyclotron();
          })
